    ...
    >
      ...
      >
        ...
        <div
          ...
          group-hover:border-purple-300/80 
        ...
        >
          ...
          <motion.span
            ...
            className="
              ...
              border-black
              bg-green-400
              shadow-[0_0_9px_rgba(74,222,128,0.95)]
            "
          />
          ...
          <div className="absolute left-[18px] top-1/2 h-[68px] w-[68px] -translate-y-1/2">
            ...
            <div
              className="absolute inset-[4px] bg-purple/80"
              style={{
                clipPath:
                  "polygon(50% 0%, 92% 25%, 92% 75%, 50% 100%, 8% 75%, 8% 25%)",
              }}
              ...
              <div className="relative h-[4px] flex-1 overflow-hidden rounded-full bg-white/10">
                ...
                <motion.div
                  ...
                  className="
                    ...
                    via-purple-400
                    to-fuchsia-300
                    shadow-[0_0_7px_rgba(168,85,247,0.9)]
                  "
                />
